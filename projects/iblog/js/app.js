...
const postMethods = () => {
    ...
    pinnedPosts.forEach((pinnedPost) => {
        ...
        postEl.innerHTML =
            ...
            <i>By <a href="#">${pinnedPost.postedBy}</a> under 
        ...
        const addBlogs = (e) => {
            if(enteredName.value === '' && enteredBlog.value === '') 
            { 
            alert('Bro write something 1st') 
            }
            else 
            {
                console.log(enteredName.value);
                console.log(enteredBlog.value);
                pinnedPosts.push(enteredName.value);
                pinnedPosts.push(enteredBlog.value);
                e.preventDefault();
